...
if sys_info.get('model').lower() == 'panorama':
    ...
    pa_utils.pa_unused_report(dev_ip, 'Panorama', unused_groups, unused_addresses)
    ...
    if vsys_root_raw:= vsys_root_resp.get('response').get('result'):
        ...
        for vsys_ins in vsys_root:
            ...
            pa_utils.pa_unused_report(dev_ip, 'firewall '+ vsys_name, unused_groups, unused_addresses)
